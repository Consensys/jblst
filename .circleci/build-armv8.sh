...
docker exec --privileged -ti $DOCKER_CONTAINER_ID apt-get install -y autoconf libpcre3 libpcre3-dev bison flex curl tar openjdk-11-jdk make git
...
docker exec --privileged -ti $DOCKER_CONTAINER_ID /bin/bash -xec \
  "cd swig-4.0.2/; sh autogen.sh; ./configure --disable-dependency-tracking; make; sudo make install; git clone -n https://github.com/supranational/blst; git checkout $1; "
