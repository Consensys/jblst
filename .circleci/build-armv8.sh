...
docker exec --privileged -ti $DOCKER_CONTAINER_ID /bin/bash -xec \
  "cd swig-4.0.2/; sh autogen.sh; ./configure --disable-dependency-tracking; make; make install; git clone -n https://github.com/supranational/blst; cd blst; git checkout $1; export JAVA_HOME=/usr/lib/jvm/java-11-openjdk-arm64; sh bindings/java/run.me;"
